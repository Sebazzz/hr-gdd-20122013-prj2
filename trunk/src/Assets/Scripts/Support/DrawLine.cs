...
public class Drawing {
    ...
    /* Robins implementation of a dotted line */
    public static void DrawDottedLine(Vector2 pointA, Vector2 pointB) {
        Vector2 beginPoint = pointA;
        Vector2 endPoint = pointB;
        ...
        for (int i = 0; i < distance / 100; i++) {
            ...
            beginPoint = Vector2.MoveTowards(beginPoint, endPoint, distance / 100);
            endPoint = Vector2.MoveTowards(endPoint, beginPoint, distance / 100);
            if(drawing)
                DrawLine(beginPoint, endPoint, GUI.contentColor, 5);
        }
